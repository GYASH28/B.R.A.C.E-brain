...
> Release status: **0.1.0 preview**. Linux is locally smoke-tested. Windows is built and tested by the repository's native GitHub Actions runner. Packages are not yet code-signed.
...
- **Windows:** `BRACE Setup 0.1.0.exe`
- **Debian / Ubuntu:** `brace-brain_0.1.0_amd64.deb`
- **Other Linux distributions:** `BRACE-0.1.0.AppImage`
...
- macOS packaging is not part of 0.1.0.
...
- Project indexing is text-oriented and does not parse PDFs, images, audio, or proprietary document formats in 0.1.0.
