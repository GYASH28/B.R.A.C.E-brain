...
SQLite, filesystems, and storage media can retain recoverable blocks after logical deletion. BRACE 0.5.0 does not claim forensic erasure.

## Encryption

BRACE 0.5.0 does not encrypt `brace.sqlite3` at the application layer. Use operating-system full-disk encryption, a strong login, automatic screen locking, and encrypted backup storage.
