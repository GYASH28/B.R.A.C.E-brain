...
assert.match(home, /app-overview\.png" width="1440" height="960" loading="lazy"/);
assert.match(home, /film-poster" src="[^"]+" width="1440" height="810" fetchpriority="high" decoding="async"/);
