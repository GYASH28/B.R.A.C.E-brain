...
const schemas = new Map([
  ...
  ["brace:cancel-project-index", z.tuple([id])],
  ...
  ["brace:prepare-assistant-context", z.tuple([assistantRequest])],
  ["brace:run-assistant", z.tuple([assistantRequest.extend({ contextId: id })])],
  ...
  ["brace:get-diagnostics", z.tuple([])],
  ["brace:stage-restore", z.tuple([])],
  ["brace:cancel-pending-restore", z.tuple([])],
  ["brace:export-support-bundle", z.tuple([])],
]);
