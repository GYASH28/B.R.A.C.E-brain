(() => {
  ...
  const downloads = {
    windows: `${releaseBase}/BRACE-Setup-0.4.0.exe`,
    linux: `${releaseBase}/BRACE-0.4.0.AppImage`,
    deb: `${releaseBase}/brace-brain_0.4.0_amd64.deb`,
  };
  ...
  q("[data-constellation-shuffle]")?.addEventListener("click", () => {
