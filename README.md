...
> Release status: **0.2.0 preview**. Linux is locally smoke-tested. Windows is built and tested by the repository's native GitHub Actions runner. Packages are not yet code-signed.
...
- **Other Linux distributions:** `BRACE-0.2.0.AppImage`
...
- macOS packaging is not part of 0.2.0.
...
- Project indexing is text-oriented and does not parse PDFs, images, audio, or proprietary document formats in 0.2.0.
