...
const scenarios = [
  {name:"home-desktop", path:"/", viewport:{width:1440,height:900}, maxFcp:2500, maxLcp:3500, maxDom:1600},
  {name:"home-mobile", path:"/", viewport:{width:390,height:844}, maxFcp:3200, maxLcp:4200, maxDom:1600},
  {name:"guide-mobile", path:"/guide/", viewport:{width:390,height:844}, maxFcp:3200, maxLcp:4200, maxDom:2400},
];
