...
0.3.0 is not code-signed. Download only from the repository release, compare the file against `SHA256SUMS.txt`, and proceed only if they match. Native signing is on the roadmap.
...
```bash
./BRACE-0.3.0.AppImage --appimage-extract
